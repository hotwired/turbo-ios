...
1. Update your dependency manager to point to `basecamp/turbo-ios` instead `turbolinks/turbolinks-ios`
...
3. Introduced a new `PathConfiguration` concept, documented here - [PathConfiguration](PathConfiguration.md)
